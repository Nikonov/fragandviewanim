...
public class MainActivity extends ListActivity {
     ...
     * #onCreate(android.os.Bundle)} because the {@link com.bradbury.example.fragmentanimationexample.MainActivity.Sample} constructor needs access to {@link
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSamples = new Sample[]{
                ...
                new Sample(R.string.title_card_flip, Card.class),
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_custom_animation:
                startActivity(new Intent(MainActivity.this, FragmentCustomAnimationSupport.class));
                return true;
        }
